...
do
  case $answer in
   [yY]* ) 
            ...
            yum -y install httpd centos-release-scl.noarch bash-completion php php-common php-opcache php-mcrypt php-cli php-curl wget yum-utils mariadb mariadb-server php-mysql php-gd php-xml php-mbstring
