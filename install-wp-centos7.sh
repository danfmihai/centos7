...
echo "Setting test info php file named info.php in html/"
echo "<?php phpinfo(); ?>" | sudo tee /var/www/html/info.php

read -p "Do you want to create a local user and database?  If user wp_user and wpdb exists will be deleted!!" answer
while true
do
  case $answer in
   [yY]* ) 
    ...
    echo "If user wp_user and wpdb exists will be deleted!!"
    ...
    mysql -u root -e "SELECT user, host FROM mysql.user;"
    echo            
    echo "Okay, just ran the script. Done!"
           break;;
